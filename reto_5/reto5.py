...
def guardad_ubicacion():
    pass


def actualizar_zonaWIFI():
    pass
...
lista_funciones = [
    ...
    ["Ubicar zona wifi más cercana", ubicar_zonaWIFI],
    ["Guardar archivo con ubicación cercana", guardad_ubicacion],
    ["Actualizar registros de zonas wifi desde archivo", actualizar_zonaWIFI],
